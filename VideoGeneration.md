...
- 📌[Controllable Generation](#Controllable-Generation)
  ...
  - [MAGICTAILOR:COMPONENT-CONTROLLABLE PERSONALIZATION IN TEXT-TO-IMAGE DIFFUSION MODELS](#MAGICTAILOR-COMPONENT-CONTROLLABLE-PERSONALIZATION-IN-TEXT-TO-IMAGE-DIFFUSION-MODELS) `[DiT]` `[2024.11]` `[preprint]` \[[paper](https://arxiv.org/pdf/2407.07860)\]\[[code](https://gaoruiyuan.com/magicdrivedit/)\]
