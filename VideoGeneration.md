...
- 📌[Controllable Generation](#Controllable-Generation)
  ...
  - Trajectory Attention for Fine-grained Video Motion Control]`[SVD]` `[2024.11]` `[ICLR25]` \[[paper](https://arxiv.org/abs/2411.19324)\]\[[project page](https://xizaoqu.github.io/trajattn/)\]
